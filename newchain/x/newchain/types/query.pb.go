...
// source: newchain/newchain/query.proto
...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_3760ed934538e7ab, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3760ed934538e7ab, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "newchain.newchain.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "newchain.newchain.QueryParamsResponse")
}

func init() { proto.RegisterFile("newchain/newchain/query.proto", fileDescriptor_3760ed934538e7ab) }

var fileDescriptor_3760ed934538e7ab = []byte{
	// 279 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0xcd, 0x4b, 0x2d, 0x4f,
	...
	0x2a, 0x0b, 0x52, 0x8b, 0x93, 0xd8, 0xc0, 0xe1, 0x64, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x0c,
	0xe5, 0x3c, 0x63, 0xdb, 0x01, 0x00, 0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/newchain.newchain.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/newchain.newchain.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "newchain.newchain.Query",
	...
	Metadata: "newchain/newchain/query.proto",
}
